...
void app_parse_input_args(i32 argc, char **argv, char **input_file, i32 *loop_flag, i32 *mic_mode, i32 *no_gui)
{
    *input_file = NULL;
    *loop_flag = 0;
    *mic_mode = 0;
...
i32 app_platform_init(app_state_t *app_state)
{
    ...
    InitAudioDevice();
    SetTargetFPS(60);               // CHANGE THE FPS HERE
...
void app_run(app_state_t *app_state)
{
    ...
    while (app_state->no_gui || !WindowShouldClose())
    {
